        ...
        <div class="center-align container section">
            ...
            <%
                ...
                try {
                    ...
                    rs = statement.executeQuery("SELECT * FROM puntuaciona where idUser='" + id + "' ORDER BY puntuacion DESC;");
                    int contador = 1;
                    while (rs.next()) {
                        String posiciontxt = "";
                        String palabrastxt = rs.getString(3).toString();
